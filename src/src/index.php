...
<?php
    ...
    if ( $db_link ) {
        ...
        $queryAngebot = mysqli_query($db_link,"SELECT `Text` FROM `aboutText` WHERE 1");
        $queryPrice = mysqli_query($db_link,"SELECT `Text` FROM `preisText` WHERE 1");
        ...
        $rowAngebot = mysqli_fetch_array($queryAngebot);
...
<div id="pointAbout" class="about">
        ...
        <div class="Lebenslauf" style="text-align: justify; line-height: 140%"><?php echo $aboutausbildung ?></div>

</div>
<div id="pointOffer" class="offer">


    <div class="OfferDiv" style="text-align: justify; line-height: 140%"><?php echo $angebot?><p style="text-align: center"><a id="goToPrice" href="#pointPrice">Zu den Preisen</a></p></div>

</div>
<div id="pointPrice" class="price">


    <div class="PriceDiv" style="text-align: justify; line-height: 140%"><?php echo $price?>
    </div>
